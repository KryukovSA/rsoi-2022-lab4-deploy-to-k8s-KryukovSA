...
public class ReservationServiceController {
    public static final String reservation_url = "http://reservation-service:8070/api/v1/reservations";
    ...
    public ResponseEntity<HashMap> takeBook(@RequestHeader("X-User-Name") String username,
        ...
        Books book = restTemplate.getForObject("http://library-service:8060/api/v1/libraries/getBook" + "?libraryUid=" + result.getLibraryUid() + "&bookUid=" + result.getBookUid(), Books.class);
        ...
        Library lib = restTemplate.getForObject("http://library-service:8060/api/v1/libraries/getLib" + "?libraryUid=" + result.getLibraryUid(), Library.class);
        ...
        Integer rating = restTemplate.getForObject("http://rating-service:8050/api/v1/rating" + "?username=" + result.getUsername(), Integer.class);
    ...
    public ResponseEntity<?> getUserReservedBooks(@RequestHeader("X-User-Name") String username) {
        ...
        Books book = restTemplate.getForObject("http://library-service:8060/api/v1/libraries/getBook" + "?libraryUid=" + mainReservation.getLibraryUid() + "&bookUid=" + mainReservation.getBookUid(), Books.class);//result.get(0)
        HashMap<String, Object> book1 = new HashMap<>();
        book1.put("bookUid", book.getBookUid());
        book1.put("name", book.getName());
        book1.put("author", book.getAuthor());
        ...
        Library lib = restTemplate.getForObject("http://library-service:8060/api/v1/libraries/getLib" + "?libraryUid=" + mainReservation.getLibraryUid(), Library.class);
        HashMap<String, Object> lib1 = new HashMap<>();
        lib1.put("libraryUid", lib.getLibraryUid());
        lib1.put("name", lib.getName());
        lib1.put("address", lib.getAddress());
