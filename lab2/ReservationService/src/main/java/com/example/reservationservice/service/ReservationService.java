...
public class ReservationService {
    ...
    public ResponseEntity<?> returnBook(String username, UUID reservationUid, ReturnBook returnBookRequest) {
        ...
        if(expired || badCondition) {
            url = "http://gateway-service:8080/api/v1/rating" + "/decrease" + "?username=" + username + "&expired=" + expired + "&badCondition=" + badCondition;
        } else {
            url = "http://gateway-service:8080/api/v1/rating" + "/increase" + "?username=" + username;
        }
